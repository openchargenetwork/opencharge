...
class EcosystemTest extends TestCase
{
    ...
    public function test_ecosystem_index_is_accessible_without_auth(): void
    {
        $response = $this->get(route('ecosystem.index'));

        $response->assertStatus(200);
    }

    public function test_ecosystem_index_displays_ocids(): void
    {
    ...
    public function test_ecosystem_index_can_search_by_name(): void
    {
        Ocid::factory()->merchant()->create(['name' => 'Coffee Shop']);
        Ocid::factory()->merchant()->create(['name' => 'Tech Store']);

        Livewire::test('pages::ecosystem.index')
            ->set('search', 'Coffee')
            ->assertSee('Coffee Shop')
            ->assertDontSee('Tech Store');
    }

    public function test_ecosystem_index_can_filter_by_type(): void
    {
    ...
    public function test_ecosystem_index_can_filter_by_capability(): void
    {
    ...
    public function test_ecosystem_show_displays_ocid_details(): void
    {
        $ocid = Ocid::factory()->merchant()->create([
            'ocid' => '1234',
            'name' => 'Test Merchant',
        ...
        $response = $this->get(route('ecosystem.show', $ocid->ocid));
    ...
    public function test_ecosystem_show_displays_kyc_providers(): void
    {
        ...
        $response = $this->get(route('ecosystem.show', $merchant->ocid));

        $response->assertStatus(200);
        $response->assertSee('TrustVerify');
    }

    public function test_ecosystem_show_displays_accepted_partners(): void
    {
    ...
    public function test_ecosystem_show_returns404_for_non_existent_ocid(): void
    {
        $response = $this->get(route('ecosystem.show', 'nonexistent'));
