        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="hidden md:flex items-center gap-1">
                    ...
                    <a href="#cross-border" class="px-3 py-2 text-sm font-medium text-blue-600 dark:text-blue-400 hover:text-blue-900 dark:hover:text-blue-100 transition-colors">Eco system</a>
                ...
                <div class="flex items-center gap-3">
                    @if (Route::has('login'))
                        @auth
                            <flux:button variant="primary" href="{{ url('/dashboard') }}">Dashboard</flux:button>
                        @else
        ...
        <section id="cta" class="py-16 lg:py-24 bg-linear-to-br from-blue-600 to-purple-700">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <p class="text-lg text-blue-100 mb-8 max-w-2xl mx-auto">
                    Enable your users to pay or accept payments from any service provider today. One integration, unlimited possibilities.
                </p>
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <flux:button href="{{ route('register') }}" class="bg-white text-blue-600 hover:bg-blue-50 text-base px-8 py-3">
                        Join the Network
                    </flux:button>
                    <flux:button variant="ghost" href="#how-it-works" class="text-white border-white hover:bg-white/10 text-base px-8 py-3">
                        Learn More
                    </flux:button>
                </div>
            </div>
